...
const it: Messages = {
  meta: {
    ...
    description:
      "Una breve e-mail al giorno con una selezione ordinata di offerte su misura per te. Tech e CZ+EU per primi. Gratis.",
  },
  ...
  roles: {
    ...
    program_management: "Gestione programmi",
  ...
  landing: {
    heroEyebrow: "Gratis · Nessun account · Fatto nella UE",
    heroTitle: "Le offerte che valgono la tua mattina — e nient'altro.",
    heroSubtitle:
      "Ogni notte JobDigest legge ogni nuovo annuncio da oltre 20 portali e registri nazionali, li confronta con ciò che cerchi davvero e al mattino ti invia una breve selezione — per ogni offerta una riga sul perché è adatta.",
    ...
    trustFree: "Gratis · 20+ fonti controllate ogni notte",
    ...
    step2Body: "Annunci freschi da 20+ fonti, ordinati per te, doppioni eliminati.",
  ...
  prefs: {
    ...
    uploadCv: "Carica un CV",
    cvReplaceConfirm:
      "Le tue selezioni attuali (ruoli, competenze, settori, livello, anni di esperienza, "
      + "istruzione) saranno sostituite da ciò che rileviamo nel CV. Nulla viene salvato "
      + "finché non premi Salva — puoi prima controllare e correggere tutto. Il file viene "
      + "letto una volta e scartato. Continuare?",
  ...
  jobs: {
    ...
    searchPlaceholder: "Ruolo, competenza o azienda",
    searchButton: "Cerca",
    startTitle: "Che cosa stai cercando?",
    startBody:
      "Cerca per ruolo, competenza o azienda — oppure scegli un settore, un paese o un livello.",
    ...
    filterCountry: "Paese",
    filterCity: "Città",
    cityNeedsCountry: "Scegli prima un paese",
    filterSeniority: "Livello",
    filterWorkMode: "Modalità",
    intlEea: "UE – internazionale",
    intlNa: "Nord America – internazionale",

...
const sk: Messages = {
  ...
  roles: {
    ...
    program_management: "Programové riadenie",
  ...
  language: {
    label: "Jazyky, ktorým rozumiete",
    any: "akýkoľvek jazyk",
    narrowed: "len tieto",
    note:
      "Angličtinu vždy ponecháme, rovnako aj inzeráty, pri ktorých sme jazyk nerozpoznali. Vynecháme len ponuky napísané celé v jazyku, ktorý ste nevybrali.",
  },
  ...
  prefs: {
    ...
    minScore: "Prah pre hlavné tipy",
    minScoreHint:
      "Aká silná musí zhoda byť (z 10), aby sa dostala do hlavnej časti e-mailu. Slabšie "
      + "zhody sa stále zobrazia na stránke s ponukami a denný tip dostanete aj vtedy, keď "
      + "prah nič neprekročí.",
  ...
  jobs: {
    ...
    intlEea: "EÚ – medzinárodné",
    intlNa: "Severná Amerika – medzinárodné",

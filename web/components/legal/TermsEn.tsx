...
/** English terms — the authoritative text. Its Czech translation is
 *  `TermsCs.tsx` and the two must change in the same commit. */
    ...
    <>
      ...
      <div className="wrap prose">
        ...
        <p>JobDigest sends you a once-daily email with a curated, ranked shortlist of job postings
          ...
          <Link href={legalHref("en", "privacy")}>Privacy Policy</Link>.</p>

...
SUBJECT_WORDS: dict[str, dict[str, str]] = {
    ...
    "cs": {
        ...
        "logistics_transport": "logistika",
        "manufacturing_production": "výroba",
        "other_tech_function": "tech",
    },
    "de": {
        "data_engineering": "Data-Engineering-",
        ...
        "software_engineering": "Entwicklungs-",
        "devops_platform": "Plattform-",
        "product": "Produkt-",
        "design": "Design-",
        "social_media": "Social-Media-",
        "marketing": "Marketing-",
        "sales": "Vertriebs-",
        "finance_accounting": "Finanz-",
        "hr_recruiting": "HR-",
        "legal": "Rechts-",
        "customer_support": "Support-",
        "operations": "Betriebs-",
        "healthcare": "Gesundheits-",
        "education": "Bildungs-",
        "hospitality": "Gastronomie-",
        "skilled_trades": "Handwerks-",
        "construction": "Bau-",
        "logistics_transport": "Logistik-",
        "manufacturing_production": "Produktions-",
        "other_tech_function": "Tech-",
    },
    "sk": {
    ...
    "pl": {
        ...
        "logistics_transport": "logistyka",
        "manufacturing_production": "produkcja",
        "other_tech_function": "tech",
    },
    "es": {
        "data_engineering": "de ingeniería de datos",
        "data_analysis": "de datos",
        "machine_learning": "de ML",
        "engineering": "de ingeniería",
        "software_engineering": "de desarrollo",
        "devops_platform": "de plataforma",
        "product": "de producto",
        "design": "de diseño",
        "social_media": "de redes sociales",
        "marketing": "de marketing",
        "sales": "de ventas",
        "finance_accounting": "de finanzas",
        "hr_recruiting": "de RR. HH.",
        "legal": "legales",
        "customer_support": "de soporte",
        "operations": "de operaciones",
        "healthcare": "de sanidad",
        "education": "de educación",
        "hospitality": "de hostelería",
        "skilled_trades": "de oficios",
        "construction": "de construcción",
        "logistics_transport": "de logística",
        "manufacturing_production": "de producción",
        "other_tech_function": "tech",
    },
    "fr": {
        "data_engineering": "en data engineering",
        "data_analysis": "data",
        "machine_learning": "en ML",
        "engineering": "d'ingénierie",
        "software_engineering": "de développement",
        "devops_platform": "plateforme",
        "product": "produit",
        "design": "design",
        ...
        "construction": "construction",
        "logistics_transport": "logistique",
        "manufacturing_production": "production",
        "other_tech_function": "tech",
    },
    "it": {
        "data_engineering": "di data engineering",
        "data_analysis": "di dati",
        "machine_learning": "di ML",
        "engineering": "di ingegneria",
        "software_engineering": "di sviluppo",
        "devops_platform": "di piattaforma",
        "product": "di prodotto",
        "design": "di design",
        "social_media": "social media",
        "marketing": "di marketing",
        "sales": "commerciali",
        "finance_accounting": "di finanza",
        "hr_recruiting": "HR",
        "legal": "legali",
        "customer_support": "di supporto",
        ...
        "logistics_transport": "logistica",
        "manufacturing_production": "produzione",
        "other_tech_function": "tech",
    },
}
